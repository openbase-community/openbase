...
urlpatterns = [
    ...
    path(
        "projects/reports/share/",
        report_share,
        name="project-reports-share",
    ),
    path(
        "projects/reports/share/grants/",
        report_share_grants,
        name="project-reports-share-grants",
    ),
    path(
        "projects/reports/share/grants/revoke/",
        report_share_revoke_grant,
        name="project-reports-share-revoke-grant",
    ),
    ...
    path(
        "settings/coding-backend/claude-plugins/",
        claude_plugin_settings,
        name="coding-backend-claude-plugin-settings",
    ),
    path(
