...
from openbase_coder_cli.livekit_agent.transcription_notice import TranscriptionTimeoutNotice
    ...
    async def run():
        for received_final in (False, True):
            ...
            ledger = VoiceDeliveryLedger(route_snapshot=lambda: VoiceRouteSnapshot(
                0, "dispatcher", None, None, "dispatcher"), vad_transcript_timeout_seconds=.015)
