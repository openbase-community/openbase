...
| `OPENBASE_CLOUD_ANTHROPIC_AUTH_TOKEN`     | No       | generated by `openbase-coder auth print-machine-token` | Test/override token for the Openbase Cloud Claude Code proxy |
...
| `OPENBASE_CLOUD_CODEX_MODEL`              | No       | `openbase-codex`                                 | Model name used by the internal Openbase Cloud Codex compatibility backend |
