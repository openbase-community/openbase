...
6. **Sign in to Openbase** — always required to link the Mac and phone and provide managed voice audio. The app opens browser OAuth and detects completion automatically.
7. **Get Openbase on your phone** — scan a QR code to open the downloads page, install the iPhone or Android app, and sign in with the same account. You can skip phone setup.
